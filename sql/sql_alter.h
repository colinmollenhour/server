...
public:
  ...
  */
  ...
  enum operations_used_flags
  {
    ...
    ALTER_ADD_CHECK_CONSTRAINT  = 1ULL << 27,
    ALTER_DROP_CHECK_CONSTRAINT = 1ULL << 28,
    ALTER_RENAME_COLUMN         = 1ULL << 29,
    ALTER_COLUMN_UNVERSIONED    = 1ULL << 30,
    ALTER_ADD_SYSTEM_VERSIONING = 1ULL << 31,
    ALTER_DROP_SYSTEM_VERSIONING= 1ULL << 32
  };
